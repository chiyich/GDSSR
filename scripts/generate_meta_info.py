...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--input',
        nargs='+',
        default=['/home/chiyc/Data/dataset/DF2K/DF2K_source_sub', '/home/chiyc/Data/dataset/DF2K/DF2K_multiscale_sub', '/home/chiyc/Data/dataset/OST/OST_sub'],
        help='Input folder, can be a list')
    parser.add_argument(
        '--root',
        nargs='+',
        default=['/home/chiyc/Data/dataset/DF2K', '/home/chiyc/Data/dataset/DF2K', '/home/chiyc/Data/dataset/OST'],
        help='Folder root, should have the length as input folders')
    parser.add_argument(
        '--meta_info',
        type=str,
        default='datasets/DF2K/meta_info/meta_info_DF2Kmultiscale+OST.txt',

...
class GDSSR_GANModel(SRGANModel):
    """RealESRNet Model"""

    def __init__(self, opt):
        super(GDSSR_GANModel, self).__init__(opt)
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        self.is_train = False
        super(GDSSR_GANModel, self).nondist_validation(dataloader, current_iter, tb_logger, save_img)
        self.is_train = True